...
## Issue
I think the modification to the AIResponse class in model.py is correct, but it's not
the only change to the code needed to make the 'AI Assistent' work. The new field seems
to have not been incorporated into the chain.
